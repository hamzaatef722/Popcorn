...
function Hero({ posters }) {
  ...
  return (
    ...
    <section className="reel-stage relative overflow-hidden h-[90dvh] bg-gradient-to-b from-velvet via-void to-void px-6 pb-16 pt-20 text-cream md:pt-28">
      ...
      <div className="relative mx-auto max-w-3xl text-center">
        ...
        >
          ...
          watch next, and rate what you&rsquo;ve already seen — all kept right here, no account needed.
        </motion.p>
